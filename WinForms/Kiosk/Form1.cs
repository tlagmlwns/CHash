                ...
                if (MessageBox.Show("카드를 오픈하시겠습니까?", " 알림", MessageBoxButtons.YesNo) == DialogResult.Yes)
                {
                    ...
                    for (int i = 1; i < pack * 5+1; i++) //1팩당 5장
                    {
                        ...
                        if (x <= 3)
                        {
                            ...
                            if (x == 1) { { hrcard1 = new HRcard1(); hrcard1.Show(); } }
                            else if (x == 2) { { hrcard2 = new HRcard2(); hrcard2.Show(); } }
                            else if (x == 3) { { hrcard3 = new HRcard3(); hrcard3.Show(); } }
                            //else if (x == 4) { { hrcard4 = new HRcard4(); hrcard4.Show(); } }
                            //else if (x == 5) { { hrcard5 = new HRcard5(); hrcard5.Show(); } }
                            HR_time++;
                        }
